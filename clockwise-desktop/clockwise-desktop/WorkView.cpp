...
void WorkView::onCreate()
{
	...
	auto InfoLabel = new Label(FastUI::Rect{ 0.0f, 120.0f, 360.0f, 135.0f }, L"You have no projects available :(");
	InfoLabel->setTextColor(Color::Gray());

	auto UsernameLabel = new Label(FastUI::Rect{ 10.0f, 565.0f, 200.0f, 585.0f }, AuthenticationSystem.getUser()->getUsername());
